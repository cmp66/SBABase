 ...
 * @author  cphillips
 */
public class PlayerAssignGenerator implements IPageGenerator
{
	private TeamManager teamManager = null;
    private StatsManager  statsManager = null;
    
    /** Creates a new instance of MainPageGenerator */
    public PlayerAssignGenerator ()
    {
    }

    public void init ()
    {
        //String wkName = "/WEB_INF/xslt/playerassign.xsl";
    ...
    public void generatePage (HttpServlet inServlet, HttpServletRequest inRequest, HttpServletResponse inResponse)
    {
        try
        {
            ...
            XSLTRenderHelper.render(inServlet, wkPageData, "playerassign.xsl", inResponse);
        }
