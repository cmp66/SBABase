 ...
 * @author  cphillips
 */
public class RosterGenerator implements IPageGenerator
{
    ...
    public void init ()
    {
        //String wkName = "/WEB_INF/xslt/roster.xsl";
    ...
    public void generatePage (HttpServlet inServlet, HttpServletRequest inRequest, HttpServletResponse inResponse)
    {
        try
        {
            ...
            XSLTRenderHelper.render(inServlet, wkPageData, "roster.xsl", inResponse);
        }
    ...
    {
    	Element wkRoster = null;
    	
    	if (inSeason != null)
    	{
    		wkRoster = teamManager.getRoster(inTeam, Integer.parseInt(inSeason));
    	}
    	else
    	{
    		wkRoster = teamManager.getRoster(inTeam, transactionManager.getCurrentTransactionsSeason());
    	}
