 ...
 * @author  cphillips
 */
public class SeriesStatsDetailGenerator implements IPageGenerator
{
    ...
    public SeriesStatsDetailGenerator ()
    {
    }
    ...
    public void generatePage (HttpServlet inServlet, HttpServletRequest inRequest, HttpServletResponse inResponse)
    {
        try
        {
            ...
            {}
            else if (wkMode.equals("ShowError"))
            {
                String wkHomeTeam = inRequest.getParameter("team");
                String wkVisitingTeam = inRequest.getParameter("otherteam");
                String wkYear = inRequest.getParameter("year");
                String wkSeries = inRequest.getParameter("series");
                wkPageData = createPageDocument(Integer.parseInt(wkYear), Integer.parseInt(wkSeries),
                        Integer.parseInt(wkHomeTeam), Integer.parseInt(wkVisitingTeam));
                XSLTRenderHelper.render(inServlet, wkPageData, "ShowSeriesStatsDetail.xsl", inResponse);
            }
        }
    ...
    {
        Element wkRoot = statsManager.getTeamSeriesStatsSummary(inYear, inSeries, inReportTeam, inOtherTeam);
