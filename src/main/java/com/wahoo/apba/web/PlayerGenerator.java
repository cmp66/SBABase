...
public class PlayerGenerator
{
    ...
    private void addPlayer(String inExtension, int inStartYear, int inStopYear)
    {
        ...
        {     
            ...
            wkReader = new BufferedReader( new InputStreamReader( (FilterInputStream) wkContent ) );
    ...
    {
        PlayerGenerator wkGenerator = new PlayerGenerator();
        
        try
        {        
            wkGenerator.init(args[0], args[1]);
        
            wkGenerator.generatePlayerURLs();
            wkGenerator.writeXML();
        }
        catch (Exception wkException)
        {
            wkException.printStackTrace();
