 ...
 * @author  cphillips
 */
public class ConstitutionGenerator implements IPageGenerator
{
    private TeamManager teamManager = null;
    
    /** Creates a new instance of MainPageGenerator */
    public ConstitutionGenerator ()
    {
    }
    ...
    public void generatePage (HttpServlet inServlet, HttpServletRequest inRequest, HttpServletResponse inResponse)
    {
        try
        {
            ...
            XSLTRenderHelper.render(inServlet, wkPageData, "constitution.xsl", inResponse);
        }
